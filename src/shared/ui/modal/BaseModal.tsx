    ...
    return (<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative bg-card rounded-lg shadow-xl w-full ${sizeClasses[size]} max-h-[90vh] flex flex-col`}>
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-border">
          ...
          <button onClick={onClose} className="p-1 rounded-lg hover:bg-surface transition-colors" aria-label={t('common.close')}>
        ...
        {footer && (<div className="p-4 sm:p-6 border-t border-border">
            {footer}
          </div>)}
      </div>
    </div>);
