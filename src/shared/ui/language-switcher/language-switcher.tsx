...
export function LanguageSwitcher({ compact = false }: LanguageSwitcherProps) {
    ...
    return (<div className="relative" data-language-switcher>
      ...
      {isOpen && (<div className="absolute right-0 top-full mt-2 w-40 rounded-lg border border-border bg-card shadow-lg z-50">
          <div className="p-1">
            {supportedLocales.map((locale) => (<button key={locale} onClick={() => {
