...
export default function FeedPage() {
    ...
    return (<div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-0 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        {isLoading ? (<PointCardSkeletonList ariaLabel={t('feed.loading')} className="px-4 sm:px-0"/>) : points.length === 0 ? (<div className="text-center py-12 px-4">
          ...
          </div>) : (<div className="space-y-4 sm:space-y-6 -mx-3 sm:mx-0">
            {points.map((point) => (<PointCard key={point.id} point={point} showAuthor={true} onPointUpdate={() => refetch()}/>))}

            {isFetchingNextPage && (<div className="flex items-center justify-center py-6">
