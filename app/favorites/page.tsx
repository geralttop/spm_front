      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-text-main">{t('favorites.title')}</h1>
            {favorites.length > 0 && (
          ...
          >
            ...
            <span className="sm:inline">{t('favorites.refresh')}</span>
          </button>
        </div>
          ...
          <>
            ...
            <div className="p-4 bg-surface border border-border rounded-lg mb-4 sm:mb-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <span className="text-sm font-medium text-text-main">{t('favorites.sortBy')}</span>
