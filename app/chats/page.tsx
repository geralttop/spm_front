...
function ChatsPageInner() {
  ...
  if (error) {
    return (
      <div className="mx-auto w-full max-w-3xl py-8 text-center text-text-muted md:max-w-4xl xl:max-w-5xl">
  ...
  return (
    <div className="mx-auto w-full min-w-0 max-w-3xl flex-1 pb-8 md:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
      ...
      {isLoading ? (
        ...
        <p className="rounded-xl border border-dashed border-border bg-muted/30 px-4 py-8 text-center text-text-muted">
